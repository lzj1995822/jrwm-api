...
public class MD5 {
	...
	public static void main(String[] args) {
		byte[] md5Bytes = MD5.computeToBytes("abcdefghijklmnopqrstuvwxyz");
		System.out.println("MD5加密后的byte密文为：" + outputBytesToString(md5Bytes));
		String md5HexStr = MD5.computeToHexStr("123456");
		System.out.println("MD5加密后的十六进制密文为：" + md5HexStr);

		byte[] md5Bytes2 = MD5.computeToBytes("abcdefghijklmnopqrstuvwxyz");
		System.out.println("MD5加密后的byte密文为：" + outputBytesToString(md5Bytes2));
		String md5HexStr2 = MD5.computeToHexStr("abcdefghijklmnopqrstuvwxyz");
